...
class kntl():
    def __init__(self):
        ...
        self.hh=input('\033[00mNegara Code Contoh +62 : \033[96m')                      
        self.number=input('\033[00mNomor Target: \033[96m')
...
try:
    print("\033[00m\t<\033[91m/\033[00m>\033[93mSpam Telpon\033[00m<\033[91m/\033[00m>\n\033[00m\t\033[41;1m   HackDay Games Mod   \033[00m")
    kntl()
    print('\n\033[00mDone.')
    while True:
         cb=input('\033[00mMengulangi Spam Call?(y/t):')
         if cb == 'y':
            os.system('python HackdaySpamCall.py')
         elif cb == 't':
            sys.exit()
         else:
